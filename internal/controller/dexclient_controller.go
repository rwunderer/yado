...
// +kubebuilder:rbac:groups=dex.caprisys.eu,resources=dexclients,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dex.caprisys.eu,resources=dexclients/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=dex.caprisys.eu,resources=dexclients/finalizers,verbs=update
